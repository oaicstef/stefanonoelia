...
*/
$emailto = 'damicos@gmail.com'; 	// Insert the email address that will receive the messages
$fromName = 'Contact';					// Insert a default "Name" email address (this field will be displayed in the email header)
$fromEmail = 'info@stefanonoelia.info';	// Insert a default "From" email address (this field will be displayed in the email header)
$subject = 'Boda Ste & Noe';		// Insert a default contact form subject
